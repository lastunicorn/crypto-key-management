...
namespace DustInTheWind.CryptoKeyManagement.Adapter.WpfUserAccess;
    ...
    private static Uri GenerateThemeUri(ThemeType themeType)
    {
        switch (themeType)
        {
            case ThemeType.Light:
                return new Uri("pack://application:,,,/DustInTheWind.CryptoKeyManagement.Wpf.Presentation;component/Styles/LightTheme.xaml");

            case ThemeType.Dark:
                return new Uri("pack://application:,,,/DustInTheWind.CryptoKeyManagement.Wpf.Presentation;component/Styles/DarkTheme.xaml");
